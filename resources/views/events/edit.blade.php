                ...
                <div class="card mb-6">
                    ...
                    <div class="card-body">
                            ...
                            <select name="establishment" id="select_mode" class="select_mode form-select">
                                ...
                                @foreach ($establishments as $establishment)
                                    <option value="{{ $establishment->id }}"
                                        @if ($establishment->id == old('establishment') || $establishment->id == $event->establishment_id) selected @endif>
                        ...
                        <div class="mb-6">
                            ...
                            <textarea id="description" name="description" class="form-control" rows="30">{{ old('description', $event->description) }}</textarea>
                            @error('description')
                                <small class="text-danger">{{ $message }}</small>
                            @enderror
                        </div>
